...
export default function PrePregnancyCTA() {
  ...
  return (
    <section className="relative py-20 md:py-28 overflow-hidden">
      <div className="absolute inset-0">
        <img
          src="https://readdy.ai/api/search-image?query=Elegant%20soft%20gradient%20abstract%20background%20with%20cream%20and%20rose%20blush%20tones%20subtle%20flowing%20shapes%20medical%20wellness%20aesthetic%20premium%20healthcare%20brand%20backdrop%20warm%20and%20calming%20atmosphere%20minimalist%20elegant%20design&width=1600&height=600&seq=prepreg-cta-bg&orientation=landscape"
          alt=""
      ...
      >
        <h2 className="font-heading text-2xl md:text-4xl font-bold text-foreground-900 mb-4">
          Start Your{' '}
          <span className="text-primary-500 italic">Pregnancy Journey</span> With Confidence
        </h2>
        <p className="text-foreground-600 text-sm md:text-base max-w-xl mx-auto mb-8 leading-relaxed">
          Schedule your preconception consultation and take the first step toward a healthy pregnancy.
        </p>
