...
import { treatmentProcessSteps } from '@/mocks/hysteroscopicSurgeryData';
        ...
        <div ref={ref} className={`transition-all duration-900 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="text-center mb-10 md:mb-14">
            ...
            <p className="text-foreground-600 text-sm md:text-base max-w-2xl mx-auto">
              Understanding the hysteroscopic surgery process helps you feel prepared and confident. Here&apos;s what happens from consultation through recovery.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
            {treatmentProcessSteps.map((item, index) => (
              <div
                key={item.step}
