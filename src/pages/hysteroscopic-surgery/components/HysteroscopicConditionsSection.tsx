...
import { hysteroscopicConditions } from '@/mocks/hysteroscopicSurgeryData';

export default function HysteroscopicConditionsSection() {
        ...
        <div ref={ref} className={`transition-all duration-900 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="text-center mb-10 md:mb-14">
            ...
            <p className="text-foreground-600 text-sm md:text-base max-w-2xl mx-auto">
              A wide range of uterine conditions can be diagnosed and treated through hysteroscopy. Tap any card to learn about symptoms, diagnosis and treatment options.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5">
            {hysteroscopicConditions.map((condition, index) => {
