...
import { hysteroscopicTimeline } from '@/mocks/hysteroscopicSurgeryData';

export default function HysteroscopicTimelineSection() {
        ...
        <div ref={ref} className={`transition-all duration-900 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="text-center mb-10 md:mb-14">
            ...
            <p className="text-foreground-600 text-sm md:text-base max-w-2xl mx-auto">
              From your first consultation through complete recovery — here&apos;s the simple, streamlined journey of hysteroscopic care.
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 md:gap-3">
              {hysteroscopicTimeline.map((step, index) => (
                <div
                  key={step.step}
