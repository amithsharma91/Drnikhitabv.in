...
interface HysteroscopicCTAProps {
  onBookAppointment: () => void;
}

export default function HysteroscopicCTA({ onBookAppointment }: HysteroscopicCTAProps) {
      ...
      <div className="relative z-10 w-full max-w-[1280px] mx-auto px-4 md:px-6 lg:px-10 text-center">
        ...
        >
          <div className="inline-flex items-center px-3 py-1.5 rounded-full bg-white/20 border border-white/30 mb-5">
            ...
            <span className="text-white text-xs font-semibold tracking-wide">Take The First Step</span>
          </div>
          <h2 className="font-heading text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-4 leading-tight">
            Ready To Experience Scarless Uterine Surgery?
          </h2>
          <p className="text-white/90 text-sm md:text-base max-w-xl mx-auto mb-8 leading-relaxed">
            Schedule a private consultation with Dr. Nikhita B Vadvadgi to discuss whether hysteroscopic surgery is the right approach for your condition. Experience the most minimally invasive surgical option in gynaecology with no incisions and same-day recovery.
          </p>
