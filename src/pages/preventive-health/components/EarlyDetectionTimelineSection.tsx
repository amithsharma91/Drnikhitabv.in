...
import { earlyDetectionTimeline } from '@/mocks/preventiveHealthData';

export default function EarlyDetectionTimelineSection() {
        ...
        <div ref={ref} className={`transition-all duration-900 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="text-center mb-10 md:mb-16">
            <div className="inline-flex items-center px-3 py-1.5 rounded-full bg-accent-100/70 border border-accent-200/50 mb-4">
              ...
              <span className="text-accent-700 text-xs font-semibold tracking-wide">Screening Timeline</span>
            </div>
            ...
            <p className="text-foreground-600 text-sm md:text-base max-w-2xl mx-auto">
              A life-stage guide to preventive screening — because the right tests at the right time can save lives.
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="space-y-6 md:space-y-0">
              {earlyDetectionTimeline.map((phase, index) => {
                  ...
                  >
                    ...
                    <div className={`w-full lg:w-[calc(50%-2rem)] ${isLeft ? 'lg:pr-10 lg:text-right' : 'lg:pl-10'}`}>
                      ...
                      >
                        ...
                        <div className="flex items-center space-x-3 mb-2 justify-start lg:justify-start">
                        ...
                        <p className="text-foreground-500 text-xs md:text-sm leading-relaxed">{phase.description}</p>
                      </div>
                    </div>
