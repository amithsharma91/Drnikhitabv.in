...
interface MISCTAProps {
  onBookAppointment: () => void;
}

export default function MISCTA({ onBookAppointment }: MISCTAProps) {
      ...
      <div className="relative z-10 w-full max-w-[1280px] mx-auto px-4 md:px-6 lg:px-10 text-center">
        ...
        >
          ...
          <p className="text-white/90 text-sm md:text-base max-w-xl mx-auto mb-8 leading-relaxed">
            Schedule a private consultation with Dr. Nikhita B Vadvadgi to discuss whether minimally invasive surgery is right for you. Experience faster recovery, less pain, and world-class surgical care.
          </p>
