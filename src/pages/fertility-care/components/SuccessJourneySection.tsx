...
import { journeyTimelineSteps } from '@/mocks/fertilityCareData';
      ...
      >
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="font-heading text-2xl md:text-4xl font-bold text-foreground-900 mt-3 mb-4">
            Fertility Success Journey
          </h2>
          <p className="text-foreground-600 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
            A structured, step-by-step pathway from your first consultation through treatment and ongoing follow-up care.
          </p>
        </div>

        <div className="relative max-w-6xl mx-auto">
          {/* Connecting line - horizontal on desktop only */}
            ...
            {journeyTimelineSteps.map((step, i) => (
              ...
              >
                ...
                <div className="lg:text-center flex-1 bg-white rounded-2xl p-4 lg:p-5 border border-background-200 hover:border-primary-200 transition-all duration-400">
                  ...
                  <span className="inline-block text-xs font-medium text-primary-500 bg-primary-50 px-2 py-0.5 rounded-full mb-2">
                    {step.duration}
                  </span>
        ...
        <div className="text-center mt-12 md:mt-16">
          <p className="text-foreground-500 text-sm italic">
            Every fertility journey is unique. Dr. Nikhita adapts each step to your individual needs, diagnosis, and personal timeline.
          </p>
        </div>
      </div>
    </section>
