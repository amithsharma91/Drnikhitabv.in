  ...
  return (
    <section className="relative py-16 md:py-24 overflow-hidden">
      <div className="absolute inset-0">
        <img
          src="https://readdy.ai/api/search-image?query=Elegant%20soft%20gradient%20abstract%20background%20with%20cream%20and%20rose%20blush%20tones%2C%20subtle%20flowing%20shapes%2C%20medical%20wellness%20aesthetic%2C%20premium%20healthcare%20brand%20backdrop%2C%20warm%20and%20calming%20atmosphere%2C%20minimalist%20elegant%20design&width=1600&height=600&seq=services-cta-bg&orientation=landscape"
          alt=""
      ...
      >
        <h2 className="font-heading text-2xl md:text-4xl font-bold text-foreground-900 mb-4">
          Personalized Women&apos;s Healthcare For Every Stage Of Life
        </h2>
        <p className="text-foreground-600 text-sm md:text-base max-w-xl mx-auto mb-8 leading-relaxed">
          Expert care tailored to your unique health needs. Schedule your consultation today.
        </p>
